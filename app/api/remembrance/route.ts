...
export async function POST(request: Request) {
  try {
    ...
    if (!Number.isInteger(body.recordId) || typeof body.visitorId !== "string" || !uuidPattern.test(body.visitorId) || typeof body.remember !== "boolean") return Response.json({ error: "잘못된 요청입니다." }, { status: 400 });
