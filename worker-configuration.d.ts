/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.personal.jsonc --env-interface CloudflareEnv worker-configuration.d.ts` (hash: f256681cd524b9cf7dbb111b5253dd58)
